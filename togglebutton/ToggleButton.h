...
class ToggleButton: public Button {
	...
	public:
        ...
        ToggleButton(int x, int y, int w, int h, 
            string content, int size, const char* up_file, const char* down_file); /*!< \brief Constructor. Sets x and y position of this element along with width, height, text, font size, and a background image */
