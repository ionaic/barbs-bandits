...
CC=g++
# object files
OFILES=Image.o Pixel.o Text.o Element.o TextElement.o Button.o TextEdit.o ToggleButton.o NumericCounter.o AbstractCounter.o FractionalCounter.o ProgressBar.o BoundedCounter.o CheckBox.o RadioButton.o OGHelper.o DropDown.o SliderBar.o
# final target
TARGET=sample
# generic element includes
INCL=-I./image/ -I./text/ -I./element/ -I./button -I./togglebutton -I./counter -I./checkbox -I./helper -I./dropdown -O3
# include all the things
HFILES=button/Button.h image/ImageElement.h text/TextElement.h counter/*.h checkbox/*.h helper/OGHelper.h dropdown/DropDown.h $(INCL) $(TXTINCL)
...
lib: cleanlib OpenGUI.o
	...
	cp helper/OGHelper.h libOpenGUI/include/libOpenGUI/OGHelper.h
...
DropDown.o:
	$(CC) dropdown/DropDown.cpp $(INCL) $(TXTINCL) -c
