...
\item[{unsigned int}]{y}
\end{DoxyParamCaption}
)}}\label{class_button_afe6b0b69a06839e5381cab7d9eaf4f10}
...
\end{DoxyParamCaption}
)}}\label{class_button_a3c5ea0097e8e4abf139a558c53f022d2}
...
\item[{string}]{txt}
\end{DoxyParamCaption}
)}}\label{class_button_a0446975c84ebf54a1a1fa88690689e34}
...
\end{DoxyParamCaption}
)}}\label{class_button_a89eeede6ce15964118eee29990872c96}


Constructor. Sets x and y position of element along width height. Uses an Image\-Elment as the background image. 



\subsection{Member Function Documentation}
\hypertarget{class_button_a836cb30a97ad2abeb67b0b0a6dc30dbd}{\index{Button@{Button}!set\-Bg\-Ig@{set\-Bg\-Ig}}
\index{set\-Bg\-Ig@{set\-Bg\-Ig}!Button@{Button}}
\subsubsection[{set\-Bg\-Ig}]{\setlength{\rightskip}{0pt plus 5cm}void Button\-::set\-Bg\-Ig (
\begin{DoxyParamCaption}
\item[{{\bf Image\-Element} $\ast$}]{img}
\end{DoxyParamCaption}
)}}\label{class_button_a836cb30a97ad2abeb67b0b0a6dc30dbd}
...
\item[{string}]{txt}
\end{DoxyParamCaption}
)}}\label{class_button_a1794b3856606e75716fc7e2611b1b711}
